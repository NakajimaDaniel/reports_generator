defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    ...
    test "when a file list is not provided, returns a error" do
      response = ReportsGenerator.build_from_many("banaaa")
  ...
  describe "fetch higher cost/2" do
    ...
    test "when the option is invalid, return an error " do
      file_name = "report_test.csv"

      response = file_name |> ReportsGenerator.build() |> ReportsGenerator.fetch_higher_cost("dd")
